 ...
 */
class Upgrader_120To130 extends JawsUpgrader
{
    /**
    ...
    function Run()
    {
        ...
        $old_schema = ROOT_JAWS_PATH . 'upgrade/Resources/schema/1.2.0.xml';
        $new_schema = ROOT_JAWS_PATH . 'upgrade/Resources/schema/1.3.0.xml';
