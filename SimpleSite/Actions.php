...
/* Layout actions */
$actions['Show']            = array('LayoutAction', _t('SIMPLESITE_SHOW'), _t('SIMPLESITE_SHOW_DESCRIPTION')); 
$actions['ShowWithoutTop']  = array('LayoutAction', _t('SIMPLESITE_SHOWWITHOUTTOP'), _t('SIMPLESITE_SHOWWITHOUTTOP_DESCRIPTION')); 
$actions['TopMenu']         = array('LayoutAction', _t('SIMPLESITE_TOPMENU'), _t('SIMPLESITE_TOPMENU_DESCRIPTION')); 
$actions['ShowTwoLevels']   = array('LayoutAction', _t('SIMPLESITE_TWOLEVELS'), _t('SIMPLESITE_TWOLEVELS_DESCRIPTION'));
