    ...
    function GetJawsInfo()
    {
        ...
        return array(
                    ...
                    array('title' => "Default gadget",
                          'value' => $GLOBALS['app']->Registry->Get('/gadgets/Settings/main_gadget')),
                    ...
                    array('title' => "GZip compression",
                          'value' => $GLOBALS['app']->Registry->Get('/gadgets/Settings/gzip_compression')),
                    array('title' => "WWW-Authentication",
                          'value' => $GLOBALS['app']->Registry->Get('/gadgets/Settings/http_auth')),
