    ...
    function GetJawsInfo()
    {
        ...
        return array(
                    ...
                    array('title' => "Default gadget",
                          'value' => $this->gadget->registry->get('main_gadget', 'Settings')),
                    array('title' => "Authentication method",
                          'value' => $this->gadget->registry->get('auth_method', 'Users')),
                    array('title' => "Mailer",
                          'value' => $this->gadget->registry->get('mailer', 'Settings')),
                    array('title' => "FTP",
                          'value' => $this->gadget->registry->get('ftp_enabled', 'Settings')),
                    array('title' => "Proxy",
                          'value' => $this->gadget->registry->get('proxy_enabled', 'Settings')),
                    array('title' => "Default theme",
                          'value' => $theme['name']),
                    array('title' => "Encryption",
                          'value' => $this->gadget->registry->get('crypt_enabled', 'Policy')),
                    array('title' => "GZip compression",
                          'value' => $this->gadget->registry->get('gzip_compression', 'Settings')),
                    array('title' => "WWW-Authentication",
                          'value' => $this->gadget->registry->get('http_auth', 'Settings')),
