...
class VisitCounter_AdminHTML extends Jaws_Gadget_HTML
{
    ...
    function Admin()
    {
        ...
        if ($this->gadget->GetPermission('UpdateProperties')) {
            ...
            $visit_counters = explode(',', $this->gadget->registry->get('visit_counters'));
            ...
            $mode_reg = $this->gadget->registry->get('mode');
            ...
            $custom_reg = stripslashes($this->gadget->registry->get('custom_text'));
