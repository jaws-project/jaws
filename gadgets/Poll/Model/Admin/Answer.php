...
class Poll_Model_Admin_Answer extends Poll_Model_Group
{
    ...
    function InsertAnswer($pid, $title, $order)
    {
        ...
        if (Jaws_Error::IsError($result)) {
            return new Jaws_Error($this::t('ERROR_ANSWER_NOT_ADDED'));
        }
    ...
    function UpdateAnswer($aid, $title, $order)
    {
        ...
        if (Jaws_Error::IsError($result)) {
            return new Jaws_Error($this::t('ERROR_ANSWER_NOT_UPDATED'));
        }
    ...
    function DeleteAnswer($aid)
    {
        ...
        if (Jaws_Error::IsError($result)) {
            $this->gadget->session->push($this::t('ERROR_ANSWER_NOT_DELETED'), RESPONSE_ERROR);
            return new Jaws_Error($this::t('ERROR_ANSWER_NOT_DELETED'));
        }
