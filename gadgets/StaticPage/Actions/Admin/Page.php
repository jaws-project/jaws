...
class StaticPage_Actions_Admin_Page extends StaticPage_Actions_Admin_Default
{
    ...
    function AddPage()
    {
        ...
        return Jaws_Header::Location(BASE_SCRIPT . '?reqGadget=StaticPage&action=ManagePages');
    }
    ...
    function EditPage()
    {
        ...
        if (Jaws_Error::IsError($page)) {
            ...
            return Jaws_Header::Location(BASE_SCRIPT . '?reqGadget=StaticPage&action=EditPage&id=' . $id);
        }
