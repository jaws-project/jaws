...
$actions['OnlineUsers']    = array('AdminAction:OnlineUsers,LayoutAction:OnlineUsers',
    _t('USERS_LAYOUT_ONLINE_USERS'),
    _t('USERS_LAYOUT_ONLINE_USERS_DESC'),
    true);

$actions['OnlineStatistics']    = array('LayoutAction:OnlineUsers',
    _t('USERS_LAYOUT_ONLINE_STATISTICS'),
    _t('USERS_LAYOUT_ONLINE_STATISTICS_DESC'),
    true);

$actions['LatestRegisteredUsers']    = array('LayoutAction:OnlineUsers',
    _t('USERS_LAYOUT_LATEST_REGISTERED_USERS'),
    _t('USERS_LAYOUT_LATEST_REGISTERED_USERS_DESC'),
    true);
