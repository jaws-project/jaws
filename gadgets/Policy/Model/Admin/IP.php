...
class Policy_Model_Admin_IP extends Jaws_Gadget_Model
{
    ...
    function AddIPRange($from_ip, $to_ip = null, $blocked = true)
    {
        ...
        if (Jaws_Error::IsError($res)) {
            ...
            return new Jaws_Error(_t('POLICY_RESPONSE_IP_NOT_ADDED', 'AddIPRange'), _t('POLICY_TITLE'));
        }
    ...
    function EditIPRange($id, $from_ip, $to_ip = null, $blocked = true)
    {
        ...
        if (Jaws_Error::IsError($res)) {
            ...
            return new Jaws_Error(_t('POLICY_RESPONSE_IP_NOT_DELETED', 'EditIPRange'), _t('POLICY_TITLE'));
        }
