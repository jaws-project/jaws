 ...
 */
class Phoo_Model_Photos extends Phoo_Model_Common
{
    /**
    ...
    {
//        $res = Jaws_FileManagement_File::uploadFiles($_FILES['logo'], $tmpDir, 'png,jpg,jpeg,bmp,gif');
        ...
        $res = Jaws_FileManagement_File::uploadFiles($photoFile, $uploaddir, 'jpg,gif,png,jpeg', false, true);
        ...
        $data = array();
        $data['user_id'] = $this->app->session->user->id;
