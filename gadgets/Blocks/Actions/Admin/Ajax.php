...
class Blocks_Actions_Admin_Ajax extends Jaws_Gadget_Action
{
    ...
    function NewBlock()
    {
        ...
        $summary = $this->gadget->request->fetch(1, 'post', false, array('filters' => 'strip_crlf'));
        $content = $this->gadget->request->fetch(2, 'post', false, array('filters' => 'strip_crlf'));
    ...
    function UpdateBlock()
    {
        ...
        $summary = $this->gadget->request->fetch(2, 'post', false, array('filters' => 'strip_crlf'));
        $content = $this->gadget->request->fetch(3, 'post', false, array('filters' => 'strip_crlf'));
        $model = $this->gadget->model->loadAdmin('Block');
