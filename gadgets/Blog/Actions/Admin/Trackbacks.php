<?php
require_once JAWS_PATH. 'gadgets/Blog/Actions/Admin/Default.php';
/**
...
class Blog_Actions_Admin_Trackbacks extends Blog_Actions_Admin_Default
{
    ...
    function ManageTrackbacks()
    {
        ...
        $tpl = $this->gadget->loadAdminTemplate('Trackbacks.html');
    ...
    function ViewTrackback()
    {
        ...
        $tpl = $this->gadget->loadAdminTemplate('Trackback.html');
