...
class Settings_Actions_Admin_Advanced extends Settings_Actions_Admin_Default
{
    ...
    function AdvancedSettings()
    {
        ...
        $saveButton->AddEvent(ON_CLICK, "Jaws_Gadget.getInstance('Settings', 'AdvancedSettings').submitAdvancedForm();");
        ...
        $gravatar->AddEvent(ON_CHANGE, "Jaws_Gadget.getInstance('Settings', 'AdvancedSettings').toggleGR();");
        $tpl->SetBlock('settings/item');
