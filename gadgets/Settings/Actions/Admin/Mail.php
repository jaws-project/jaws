...
class Settings_Actions_Admin_Mail extends Settings_Actions_Admin_Default
{
    ...
    function MailSettings()
    {
        ...
        $saveButton->AddEvent(ON_CLICK, "Jaws_Gadget.getInstance('Settings', 'MailSettings').submitMailSettingsForm();");
        ...
        $mailer->AddEvent(ON_CHANGE, "Jaws_Gadget.getInstance('Settings', 'MailSettings').changeMailer();");
