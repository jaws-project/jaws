...
class Jaws_Layout
{
    ...
    function Jaws_Layout()
    {
        ...
        $keywords = $GLOBALS['app']->Registry->Get('site_keywords', 'Settings');
    ...
    {
        if ($GLOBALS['app']->Registry->Get('site_status', 'Settings') == 'disabled' &&
        ...
        $favicon = $GLOBALS['app']->Registry->Get('site_favicon', 'Settings');
        if (!empty($favicon)) {
        ...
        $site_url = $GLOBALS['app']->Registry->Get('site_url', 'Settings');
        ...
        $this->_Template->SetVariable('site-name',        $GLOBALS['app']->Registry->Get('site_name', 'Settings'));
        $this->_Template->SetVariable('site-slogan',      $GLOBALS['app']->Registry->Get('site_slogan', 'Settings'));
        $this->_Template->SetVariable('site-comment',     $GLOBALS['app']->Registry->Get('site_comment', 'Settings'));
        $this->_Template->SetVariable('site-author',      $GLOBALS['app']->Registry->Get('site_author', 'Settings'));
        $this->_Template->SetVariable('site-license',     $GLOBALS['app']->Registry->Get('site_license', 'Settings'));
        $this->_Template->SetVariable('site-copyright',   $GLOBALS['app']->Registry->Get('copyright', 'Settings'));
        $cMetas = unserialize($GLOBALS['app']->Registry->Get('custom_meta', 'Settings'));
        if (!empty($cMetas)) {
    ...
    function PutTitle()
    {
        if (!empty($this->_Title)) {
            $pageTitle = array($this->_Title, $GLOBALS['app']->Registry->Get('site_name', 'Settings'));
        } else {
            $slogan = $GLOBALS['app']->Registry->Get('site_slogan', 'Settings');
            $pageTitle   = array();
            $pageTitle[] = $GLOBALS['app']->Registry->Get('site_name', 'Settings');
            if (!empty($slogan)) {
                $pageTitle[] = $slogan;
            }
        }
        $pageTitle = implode(' ' . $GLOBALS['app']->Registry->Get('title_separator', 'Settings').' ', $pageTitle);
    ...
    function PutDescription()
    {
        if (empty($this->_Description)) {
            $this->_Description = $GLOBALS['app']->Registry->Get('site_description', 'Settings');
        }
    ...
    {
        $output = '';
        $enabled = $GLOBALS['app']->Registry->Get('enabled', $gadget);
