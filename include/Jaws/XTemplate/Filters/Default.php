...
class Jaws_XTemplate_Filters_Default extends Jaws_XTemplate_Filters
{
     ...
     * @return string
     */
    public static function datetostr($input, $format = '', $calendar = '')
    {
     ...
     * @return int
     */
    public static function strtodate($input, $calendar = '')
    {
        $result = 0;
        if (!empty($input)) {
     ...
     * @return string
     */
    public static function timetostr($input, $format = '')
    {
     ...
     * @return int
     */
    public static function strtotime($input)
    {
