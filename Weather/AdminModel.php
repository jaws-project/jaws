...
class Weather_AdminModel extends Weather_Model
{
    ...
    {
        $res = array();
        $res[] = $this->gadget->registry->set('unit', $unit);
        $res[] = $this->gadget->registry->set('update_period', $update_period);
        $res[] = $this->gadget->registry->set('date_format', $date_format);
        $res[] = $this->gadget->registry->set('api_key', $api_key);
